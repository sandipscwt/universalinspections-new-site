        ...
        <div className={`flex flex-col ${width}`}>
            ...
            >
                <input
                    ...
                    className="flex-1 px-4 pr-10 font-glacial-regular  text-[clamp(12px,4vw,16px)]
          text-[#000000] ] placeholder-[#000000] focus:outline-none rounded-md"
                />

                {icon && (
                    <div
                        className={`absolute right-3 flex items-center justify-center ${clickable ? "cursor-pointer hover:opacity-80" : "pointer-events-none"
                            }`}
