                ...
                <Container className={`${style.financeCard}`}>
                    ...
                    <div className="items-center flex justify-center">
                        <h3 className={`${style.financeTitle}`}>
                            Found {financingPartners.length} Associates near 90010
                        </h3>
                            ...
                            >
                                <div>
                                    <div className={'flex flex-row'}>
                                        ...
                                        <h4 className={`${style.Financercom}`}>McKinnon Toyota</h4>
                                    </div>

                                    <div className={'flex flex-row mt-[18px]'}>
                                        <div>
                                            <Image
                                                src="/images/associates/location.png"
                                                alt="Finance Company"
                                                height={18}
                                                width={13}
                                                className="object-cover"
