...
const InspectorsOpportunities = () => {
    return (
        <section className={`${style.sectionContainer} bg-[#ffffff]`}>
            <Container>
                <div className={`${style.titleContainer}`}>
                    <h2>Inspector Opportunities</h2>
                    <p>
                        {`Join the Universal Inspections family as a skilled inspector and be part of a team where your contributions truly matter! We&quot;re more than just colleagues; we&quot;re a supportive and goal-oriented group that celebrates each other&quot;s success`}
                    </p>
                </div>
                    ...
                    <div>
                        <div className="w-full h-auto ">
                            <div className="relative w-full  h-auto">
                                <Image
                                    src="/images/opportunitie/inspector.jpg"
                                    alt="Driven Section"
                                    layout="responsive"
                                    width={555}
                                    height={434}
